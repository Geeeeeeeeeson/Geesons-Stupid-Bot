...
## format {item: {name: str, description: str, price: int, emoji: str, rarity: str, type: str, sellable: bool, sell_price: int, usable: bool, shareable: bool}}

INVENTORY = {'pickaxe':
                 {'name': 'Pickaxe', 'description': 'A pickaxe for mining.', 'price': 1200,
                  'emoji': '\u26cf\ufe0f', 'rarity': 'common', 'type': 'tool',
                  'sellable': True, 'sell_price': 100, 'usable': True, 'shareable': False},
             'apple':
                 {'name': 'Apple', 'description': 'A delicious apple.', 'price': 100,
                  'emoji': '\U0001f34e', 'rarity': 'common', 'type': 'food',
                  'sellable': False, 'sell_price': 0, 'usable': True, 'shareable': True},}
